          ...
          onClick={() => {
            if (new Date(`${minYear}-${minMonth + 1}-${minDate} ${minHours}:${minMinutes}`)) {
              if (max) {
                ...
                setMin(new Date(`${minYear}-${minMonth + 1}-${minDate} ${minHours}:${minMinutes}`));
              }
            }
          }}
        >
          ...
          onClick={() => {
            if (new Date(`${maxYear}-${maxMonth + 1}-${maxDate} ${maxHours}:${maxMinutes}`)) {
              if (min) {
                ...
                setMax(new Date(`${maxYear}-${maxMonth + 1}-${maxDate} ${maxHours}:${maxMinutes}`));
              }
            }
          }}
        >
